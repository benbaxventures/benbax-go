...
export function WalletCheckoutScreen({ navigation, route }: Props) {
  ...
  async function finalizeTopup() {
    ...
    try {
      ...
      // Navigate to the Earnings tab (riders see earnings) or Wallet tab if added
      // Replace the stack so user returns to main tabs
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore
      navigation.replace('MainTabs', { screen: 'Earnings' });
