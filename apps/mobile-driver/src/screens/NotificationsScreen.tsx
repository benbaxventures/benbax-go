...
import { ArrowLeft, Bell, BellOff, Car, CheckCheck, Package, UserPlus } from 'lucide-react-native';
          ...
          {notifications.length === 0 ? (
            ...
            >
              ...
              <Text style={{ color: theme.colors.muted, fontSize: 13, textAlign: 'center' }}>
                New ride and delivery requests, offers, and updates will show up here.
              </Text>
            </View>
          ) : (
