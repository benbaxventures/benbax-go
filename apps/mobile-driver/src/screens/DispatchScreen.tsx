    ...
    <Screen>
      <View style={{ gap: 6 }}>
        ...
        <Text style={{ color: theme.colors.muted }}>
          Go online to receive nearby passenger trip requests.
        </Text>
      </View>
      ...
      >
        ...
        <Text style={{ color: isOnline ? '#D7FFF5' : theme.colors.muted }}>
          {loading ? 'Updating...' : 'Tap to change availability'}
        </Text>
      </Pressable>
      ...
      >
        ...
        {currentOffer ? (
          ...
          <Text style={{ color: theme.colors.muted }}>
            No active request. Fresh GPS, high acceptance, and strong ratings improve matching.
          </Text>
        )}
      </View>
    </Screen>
