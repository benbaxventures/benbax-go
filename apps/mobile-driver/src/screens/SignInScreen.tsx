...
export function SignInScreen() {
  ...
  return (
    ...
    >
      <View style={{ gap: 18 }}>
        <View style={{ gap: 8 }}>
          <Text style={{ fontSize: 32, fontWeight: '900', color: theme.colors.ink }}>Benbax Driver</Text>
          <Text style={{ color: theme.colors.muted, fontSize: 16 }}>Earn with passenger trips, clear routes, and safety-first dispatch.</Text>
        </View>
        ...
        <Button
          label={mode === 'login' ? 'New driver onboarding' : 'I already drive with Benbax'}
