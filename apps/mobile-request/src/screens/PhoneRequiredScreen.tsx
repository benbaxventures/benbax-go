 ...
 * placeholder. Without a real number the passenger's driver cannot call them,
 * SMS and WhatsApp notifications silently go nowhere, and a password reset
 * code can only ever arrive by email.
 *
 * It blocks the app the same way the biometric gate does, because a ride
 * booked by someone nobody can reach is worse than a ride not booked. Signing
      ...
      <View style={{ gap: 20 }}>
        ...
        <View style={{ gap: 8 }}>
          ...
          <Text style={{ fontSize: 15, color: theme.colors.muted, lineHeight: 21 }}>
            ...
            Your driver calls this number to find you at pickup, and we send trip updates and
            password reset codes to it. Google sign-in does not share it with us.
          </Text>
        </View>
