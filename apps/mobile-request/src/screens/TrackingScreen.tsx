...
function LazyMap({
  ...
  return (
    ...
    >
      ...
      {latestPoint ? (
        <Marker coordinate={latestPoint} title="Rider" pinColor={theme.colors.primary} />
      ) : null}
      ...
      <View style={{ flex: 1, gap: 12 }}>
        <View style={{ gap: 8 }}>
          ...
          <Text style={{ color: theme.colors.muted }}>
            OTP verification and proof of delivery protect both sides.
          </Text>
        </View>
        ...
        >
          <Text style={{ fontWeight: '900', color: theme.colors.ink }}>
            {rider?.user?.fullName ?? 'Rider'} is on the way
          </Text>
          <Text style={{ color: theme.colors.muted }}>
