...
function FatalErrorFallback() {
  return (
    ...
    >
      ...
      <Text
        style={{ color: theme.colors.muted, textAlign: 'center', marginTop: 8, lineHeight: 20 }}
      >
        The app encountered an error during initialisation. Restart the app or reinstall if the
        issue persists.
      </Text>
    </View>
  );
