// Vendored from packages/shared/src/apiErrors.ts. This app does not depend
// on the workspace package (its Metro setup pins a separate Expo SDK), so the
// canonical copy lives there and is mirrored here; keep the two in step.
